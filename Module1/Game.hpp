...
private:
    ...
    struct Systems {
        void MovementSystem(std::vector<std::shared_ptr<Component::Transform>> transforms, std::vector < std::shared_ptr < Component::LinearVelocity>> linearVelocities);
		void PlayerControllerSystem(std::vector<std::shared_ptr<Component::Transform>> transforms, std::vector<std::shared_ptr<Component::PlayerController>> playerControllers);
		void RenderSystem(std::vector<std::shared_ptr<Component::Transform>> transforms, std::vector<std::shared_ptr<Component::Mesh>> meshes);
		void NpcControllerSystem(std::vector<std::shared_ptr<Component::Transform>> transforms, std::vector<std::shared_ptr<Component::NpcController>> npcControllers);
		void PointLightSystem(std::vector<std::shared_ptr<Component::Transform>> transforms, std::vector<std::shared_ptr<Component::PointLight>> pointLights);
		void CameraSystem(std::vector<std::shared_ptr<Component::Transform>> transforms, std::vector<std::shared_ptr<Component::Camera>> cameras);
